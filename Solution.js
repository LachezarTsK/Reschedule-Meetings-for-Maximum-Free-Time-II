 ...
 * @param {number[]} startEventTime
 * @param {number[]} endEventTime
 * @return {number}
 */
var maxFreeTime = function (eventTime, startEventTime, endEventTime) {
    const numberOfEvents = startEventTime.length;

    const forwardMaxFreeTime = new Array(numberOfEvents + 1);
    ...
    const backwardMaxFreeTime = new Array(numberOfEvents + 1);
